...
function Welcome() {
    return(
        <div>
            <img src={logo} className="welcome-title"></img>
            <h6 className="welcome-subtitle"><b>FOMO</b> &#x2022; /ˈfōmō/ &#x2022; noun: "the fear of missing out 
            on something that others are experiencing"</h6>
