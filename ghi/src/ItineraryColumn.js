      ...
      {data.itineraries.map((itinerary) => {
        return (
          <Card
            ...
            style={{ width: "25rem" }}
          >
            <Card.Header as="h6">{itinerary.name} <Link to="/ItineraryDetail"><Button variant="outline-primary" size="sm" style={{ float: "right" }}>Go to Itinerary</Button></Link></Card.Header>
            <Card.Body>
