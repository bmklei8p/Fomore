    ...
    return (
      <div>
        {this.state.restaurants.map((restaurant) =>
            <Card className="item-border" border="light" style={{ width: '50rem' }}>
              <Container>
                <Row>
                  <Col>
                  ...
                  <Col>
                    <Card.Body>
                      <Row>
                        ...
                        <Col sm={2}>
                          <NavLink style={{ "text-align": 'right', color: "#FA7F08" }}>&#10010;</NavLink>
                        </Col>
                      </Row>
                      <Row>
                        <Col>
                        ...
                        <Col>
                          <Card.Text style={{ "text-align": 'right'}}>Rating: {restaurant.rating}</Card.Text>
                        </Col>
                      </Row>
                      <Row>
                        <Col>
